...
def main() -> int:
    p = argparse.ArgumentParser(description=__doc__); p.add_argument("path"); p.add_argument("--kind", choices=["transcript", "captions", "layout"], required=True); p.add_argument("--duration", type=float, required=True); p.add_argument("--epsilon", type=float, default=0.05)
